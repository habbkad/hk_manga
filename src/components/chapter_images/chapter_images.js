...
const ChapterImages = () => {
  ...
  console.log(chapImages);
  const dispatch = useDispatch();
  const chapters = [2, 3, 45, 5, 3, 2, 1, 2, 3, 4, 4, 4, 3, 2, 2];
  useEffect(() => {
  ...
  return (
    <div>
      <div className="chap_number flex place-content-center">
        <p class="text-2xl font-normal text-gray-900 dark:text-white">
          MangaTitle
        </p>

        <p class="text-2xl font-normal text-gray-900 dark:text-white ml-6">
          MangaChapter:01
        </p>
      </div>
